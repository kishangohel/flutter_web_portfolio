...
import '../features/linked_in/presentation/pages/linked_in_page.dart';
import '../features/twitter/presentation/pages/twitter_page.dart';
import '../features/web/presentation/pages/web_page.dart';
...
class PersonalPortfolioColors {
  ...
  static Map<String, LinearGradient> pageColor = {
    WelcomePage.route: const LinearGradient(
      colors: [PersonalPortfolioColors.welcomePrimary, PersonalPortfolioColors.welcomeSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    TwitterPage.route: const LinearGradient(
      colors: [PersonalPortfolioColors.twitterPrimary, PersonalPortfolioColors.twitterSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    LinkedInPage.route: const LinearGradient(
      colors: [PersonalPortfolioColors.linkedInPrimary, PersonalPortfolioColors.linkedInSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    WebPage.route: const LinearGradient(
      colors: [PersonalPortfolioColors.webPrimary, PersonalPortfolioColors.webSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    ),
    GithubPage.route: const LinearGradient(
      colors: [PersonalPortfolioColors.githubPrimary, PersonalPortfolioColors.githubSecondary],
      begin: Alignment.topCenter,
      end: Alignment.bottomCenter,
    )
  };
